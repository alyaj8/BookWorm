    ...
    return (
        ...
        <NavigationContainer>
            <Tab.Navigator 
                ...
                screenOptions={({ route }) => ({ //route means the location u r at

                    tabBarIcon: ({ focused, color, size }) => {//function
                        let iconName;
                        let rn = route.name;
...
//check the location 
            if (rn === HomeName) {
              ...
              iconName = focused ? 'ellipsis-horizontal-circle-sharp' : 'ellipsis-horizontal-circle';
            }
