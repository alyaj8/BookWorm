    ...
    <SafeAreaView style={{ flex: 1 }}>
          ...
          >
            ...
            <View style={{ flex: 1, flexDirection: "row" }}>
              ...
              >
                ...
                But what will happen to those used books that are no longer
                needed?{"\n"}
                and how to make the reading community alive {"\n"}like it used
                to be in the past?.{"\n"}
                Thats when Bookworm becomes handy.{"\n"}
                This platform helps readers by providing a space for sharing
                their list of favorite books to others along with the ability to
                search any book they desire and see the reviews. Also,
                {"\n"}they can know more about the book like who’s the author
                and where they can read/buy it.
      ...
      <View>
        <ScrollView>
          ...
          >
            <Text
              style={{ fontSize: 24, fontWeight: "700", paddingHorizontal: 30 }}
            >
